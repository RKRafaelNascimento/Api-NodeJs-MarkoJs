...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/NodeJsAlura$1.0.0/src/app/views/list.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1> List NodeJs </h1><table><tr><td>Title</td></tr>");
...
marko_template.meta = {
    id: "/NodeJsAlura$1.0.0/src/app/views/list.marko",
    tags: [
