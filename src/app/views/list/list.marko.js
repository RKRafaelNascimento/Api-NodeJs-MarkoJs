...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/NodeJsAlura$1.0.0/src/app/views/list/list.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1> Listagem de livros </h1><table id=\"livros\"><tr><td>ID</td><td>T�tulo</td><td>Pre�o</td><td>Editar</td><td>Remover</td></tr>");
...
marko_template.meta = {
    id: "/NodeJsAlura$1.0.0/src/app/views/list/list.marko",
    tags: [
